...
from mhlib.scheduler import GVNS, PBIG, Method
...
def run_pbig_demo(problem_name: str, Instance, Solution, default_inst_file: str, own_settings=None):
    """Run PBIG for any of the demo problems specified by the parameters."""
    parser = get_settings_parser()
    parser.add("--inst_file", type=str, default=default_inst_file,
               help='problem instance file')
    parser.add("--meths_ch", type=int, default=1,
